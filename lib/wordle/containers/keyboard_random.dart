...
class KeyboardRandom extends StatefulWidget {
  const KeyboardRandom(
      {super.key,
      required this.sayi,
  ...
  final String uid;
  @override
  State<KeyboardRandom> createState() => _KeyboardRandomState();
}

class _KeyboardRandomState extends State<KeyboardRandom> {
